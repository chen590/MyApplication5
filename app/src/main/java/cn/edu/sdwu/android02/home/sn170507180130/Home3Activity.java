                ...
                cameraCaptureSession.capture(builder.build(),new CameraCaptureSession.CaptureCallback(){
                    ...
                    public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                        try {
                            ...
                            Log.e(Home3Activity.class.toString(),e.toString());
                        }
                    }
                },null);
            }catch (Exception e){
        ...
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
            ...
            stateCallback= new CameraDevice.StateCallback() {
                ...
                public void onOpened(@NonNull CameraDevice cameraDevice) {
                    ...
                    Home3Activity.this.cameraDevice=cameraDevice;
                    //准备预览时使用的组件
                        ...
                        imageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
                            ...
                            public void onImageAvailable(ImageReader imageReader) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Home3Activity.this,"save:"+file,Toast.LENGTH_LONG).show();
                                }catch (Exception e){
                                    Log.e(Home3Activity.class.toString(),e.toString());
                                }finally {
                                    try {
                                        ...
                                        Log.e(Home3Activity.class.toString(),ee.toString());
                                    }
                                }
                            }
                        },null);
                ...
                public void onDisconnected(@NonNull CameraDevice cameraDevice) {
                    Home3Activity.this.cameraDevice=null;
                }
    ...
    private void setCameraLayout(){
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
                Home3Activity.this.surfaceTexture=surfaceTexture;
